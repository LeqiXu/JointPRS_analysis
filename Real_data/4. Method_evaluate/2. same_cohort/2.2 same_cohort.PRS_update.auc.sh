...
write.table(prs_final_table,paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/same_cohort/PRS/PRS_update_same_cohort_auc.csv"),quote=F,sep='\t',row.names=F,col.names=T)