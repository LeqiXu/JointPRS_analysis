...
beta_df = fread(paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/diff_cohort/PROSPER/",trait,"_PROSPER_update_EUR_EAS_AFR_SAS_AMR_beta_",pop2,".txt"))
beta_df = beta_df[,c("rsid","a1","weight")]

write.table(beta_df, file=paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/diff_cohort/PROSPER/",trait,"_PROSPER_update_EUR_EAS_AFR_SAS_AMR_beta_",pop2,".txt"), 
