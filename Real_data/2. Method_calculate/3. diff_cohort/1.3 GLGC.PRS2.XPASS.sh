...
file_path = paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/diff_cohort/XPASS/",trait,"_XPASS_EUR_",pop2,"_beta_",pop2,".txt")
...
if (pop2 == "EAS" || pop2 == "AMR"){
    glm_pop2 <- paste0('/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/summary_data/XPXP/',trait,'_',pop2,'_inter_XPXP.txt') # target
} else{
    glm_pop2 <- paste0('/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/summary_data/XPXP/',trait,'_',pop2,'_inter_UKB_XPXP.txt') # target
}
...
write.table(final_beta, file=paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/result/summary_result/Final_weight/diff_cohort/XPASS/",trait,"_XPASS_EUR_",pop2,"_beta_",pop2,".txt"), row.names=F, col.names=T, quote=F, append=F)
}
}
}