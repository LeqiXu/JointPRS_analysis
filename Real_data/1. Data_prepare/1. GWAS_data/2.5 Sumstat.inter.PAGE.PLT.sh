...
sumstat = sumstat[!duplicated(sumstat$rs_number),c("CHR","POS","reference_allele","other_allele","eaf","beta","se","z","p-value","n_samples")]
...
# 2.5.2 PLT ldsc
## SNP size
## PLT EUR_inter: 800321 EAS_inter: 747306 AFR_inter: 827738
...
# 2.5.3 PLT method data
## Sample size
## PLT EUR_inter: 539667 EAS_inter: 179000 AFR_inter: 29328
