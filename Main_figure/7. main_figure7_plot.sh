## Figure7: diff_cohort_PRS_violin_plot.png 13cm width X 15.5cm height (600dpi)
library(data.table)
library(dplyr)
library(tidyr)
library(ggplot2)
...
AoU_plot = ggarrange(combined_plot_GLGC,p_PAGE_AFR,ncol = 1, nrow = 2, heights = c(1, 0.5), labels = c("a","b"),font.label = list(size = 7, face = "bold"))
print(AoU_plot)

ggsave("diff_cohort_PRS_violin_plot.png", plot = AoU_plot, width = 13, height = 15.5, dpi = 600, units = "cm", bg = "white")
