## Figure4: sim_PRS_tune_bar_plot_80K_highp.png 13cm width X 15.5cm height (600dpi)
library(data.table)
library(dplyr)
library(tidyr)
library(ggplot2)
...
ggsave("sim_PRS_tune_bar_plot_80K_highp.png", plot = combined_plot_80K_highp, width = 13, height = 15.5, dpi = 600, units = "cm", bg = "white")
