## Figure2: sim_PRS_violin_plot.png 13cm width X 15.5cm height (600dpi)
## no_val figure
library(data.table)
library(dplyr)
library(tidyr)
...
combined_plot = ggarrange(combined_plot_noval,combined_plot_val,ncol = 1, nrow = 2, labels = c("a","b"),font.label = list(size = 7, face = "bold"))
print(combined_plot)

ggsave("sim_PRS_violin_plot.png", plot = combined_plot, width = 13, height = 15.5, dpi = 600, units = "cm", bg = "white")
