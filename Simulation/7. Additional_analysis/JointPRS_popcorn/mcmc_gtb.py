...
def mcmc(a, b, phi, rho, snp_dict, beta_sumstat, frq_dict, idx_dict, n, ld_blk, blk_size, n_iter, n_burnin, thin, pop, chrom, out_dir, out_name, meta, seed):
    print('... MCMC ...')
    ...
    rho = np.array(rho).reshape(n_pop, n_pop)
