...
def parse_param():
    long_opts_list = ['ref_dir=', 'bim_prefix=', 'sst_file=', 'rho=', 'a=', 'b=', 'phi=', 'n_gwas=', 'pop=', 
                      'n_iter=', 'n_burnin=', 'thin=', 'out_dir=', 'out_name=', 'chrom=', 'meta=', 'seed=', 'help']

    param_dict = {'ref_dir': None, 'bim_prefix': None, 'sst_file': None, 'rho': None, 'a': 1, 'b': 0.5, 'phi': None, 'n_gwas': None, 'pop': None,
    ...
    if len(sys.argv) > 1:
        ...
        for opt, arg in opts:
            ...
            elif opt == "--rho": param_dict['rho'] = list(map(float,arg.split(',')))
    ...
    if param_dict['ref_dir'] == None:
        ...
        sys.exit(2)
    elif param_dict['rho'] == None:
        print('* Please provide the correlation --rho\n')
...
def main():
    ...
    for chrom in param_dict['chrom']:
        ...
        mcmc_gtb.mcmc(param_dict['a'], param_dict['b'], param_dict['phi'], param_dict['rho'], snp_dict, beta_dict, frq_dict, idx_dict, param_dict['n_gwas'], ld_blk, blk_size,
