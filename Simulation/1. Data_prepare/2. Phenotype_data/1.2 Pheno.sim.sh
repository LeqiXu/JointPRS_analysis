...
if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover/${pop}_sim${i}_p${p}_rho${rho}_100K.phen" ]] && [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover/${pop}_sim${i}_p${p}_rho${rho}_15K.phen" ]]; then
        sbatch <<EOT
#!/bin/bash
...
#SBATCH --output=out_phenotype_GWAS_simulation_${pop}_p${p}_rho${rho}_i${i}_d.txt
  ...
  # discover phenotype
  if [[ ${pop} == "EUR" ]] && [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover/${pop}_sim${i}_p${p}_rho${rho}_100K.phen" ]]; then
    ...
    --simu-hsq 0.4 \
    --simu-rep 1 \
    --out /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover/${pop}_sim${i}_p${p}_rho${rho}_100K
  fi

  if [[ ${pop} != "EUR" ]] && [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover/${pop}_sim${i}_p${p}_rho${rho}_15K.phen" ]]; then
    /gpfs/gibbs/pi/zhao/lx94/JointPRS/method/gcta64/gcta-1.94.1 --bfile /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/geno_data/${pop}/discover/${pop} \
    --extract /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/effect_data/${pop}_sim${i}_p${p}_rho${rho}.snplist \
...
do
  mkdir -p /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate
done
...
for p in 0.001 0.01 5e-04 0.1; do
for pop in EAS AFR SAS AMR; do
if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_20K.phen" ]] || [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_25K.phen" ]]; then
        sbatch <<EOT
#!/bin/bash
#SBATCH --partition=scavenge,day,week
#SBATCH --requeue
...
#SBATCH --time=1-00:00:00
#SBATCH --mail-type=ALL
#SBATCH --job-name=phenotype_GWAS_simulation_${pop}_p${p}_rho${rho}_i${i}_dv
#SBATCH --output=out_phenotype_GWAS_simulation_${pop}_p${p}_rho${rho}_i${i}_dv.txt

  # discover_validate phenotype
  if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_20K.phen" ]]; then
  ...
  --simu-hsq 0.4 \
  --simu-rep 1 \
  --out /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_20K
  fi

  if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_25K.phen" ]]; then
  /gpfs/gibbs/pi/zhao/lx94/JointPRS/method/gcta64/gcta-1.94.1 --bfile /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/geno_data/${pop}/discover_validate/${pop} \
  --extract /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/effect_data/${pop}_sim${i}_p${p}_rho${rho}.snplist \
  ...
  --simu-hsq 0.4 \
  --simu-rep 1 \
  --out /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_25K
  fi
EOT
fi
done
...
for p in 0.001 0.01 5e-04 0.1; do
for pop in EAS AFR SAS AMR; do
if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_85K.phen" ]] || [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_90K.phen" ]]; then
        sbatch <<EOT
#!/bin/bash
#SBATCH --partition=scavenge,day,week
#SBATCH --requeue
...
#SBATCH --output=out_phenotype_GWAS_simulation_${pop}_p${p}_rho${rho}_i${i}_dv.txt
  ...
  # discover_validate phenotype
  if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_85K.phen" ]]; then
  /gpfs/gibbs/pi/zhao/lx94/JointPRS/method/gcta64/gcta-1.94.1 --bfile /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/geno_data/${pop}/discover_validate/${pop} \
  --extract /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/effect_data/${pop}_sim${i}_p${p}_rho${rho}.snplist \
  ...
  --simu-hsq 0.4 \
  --simu-rep 1 \
  --out /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_85K
  fi

  if [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_90K.phen" ]]; then
  /gpfs/gibbs/pi/zhao/lx94/JointPRS/method/gcta64/gcta-1.94.1 --bfile /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/geno_data/${pop}/discover_validate/${pop} \
  --extract /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/effect_data/${pop}_sim${i}_p${p}_rho${rho}.snplist \
  ...
  --simu-hsq 0.4 \
  --simu-rep 1 \
  --out /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/discover_validate/${pop}_sim${i}_p${p}_rho${rho}_90K
  fi
EOT
fi
done
...
# UKB based testing data for non-EUR
rho=0.8 

for i in {1..5}; do 
for p in 0.001 0.01 5e-04 0.1; do
for pop in EAS AFR SAS AMR; do
if [[ ${pop} != "EUR" ]] && [[ ! -e "/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/test/${pop}_sim${i}_p${p}_rho${rho}_UKB.phen" ]]; then
sbatch <<EOT
#!/bin/bash
#SBATCH --partition=scavenge,day,week
#SBATCH --requeue
...
#SBATCH --output=out_phenotype_GWAS_simulation_${pop}_p${p}_rho${rho}_i${i}.txt
    ...
    --simu-hsq 0.4 \
    --simu-rep 1 \
    --out /gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/${pop}/test/${pop}_sim${i}_p${p}_rho${rho}_UKB
EOT
fi
done
done
...
# test participants pheno data from UKB
library(data.table)
...
for (pop in c("EAS","AFR","SAS","AMR")){
  test_data_all = fread(paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/",pop,"/test/",pop,"_sim",i,"_p",p,"_rho",rho,"_UKB.phen"))
  test_data_UKB = test_data_all
  test_data_UKB[,c(3)] = scale(test_data_UKB[,c(3)])
  colnames(test_data_UKB) = c("FID","IID","pheno")

  write.table(test_data_UKB, paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/",pop,"/test/",pop,"_sim",i,"_p",p,"_rho",rho,"_UKB_doubleid.tsv"), row.names=F, col.names=F, quote = F, sep = "\t")
  write.table(test_data_UKB, paste0("/gpfs/gibbs/pi/zhao/lx94/JointPRS/revision/data/sim_data/pheno_data/",pop,"/test/",pop,"_sim",i,"_p",p,"_rho",rho,"_UKB_doubleidname.tsv"), row.names=F, col.names=T, quote = F, sep = "\t")  
}
}
}