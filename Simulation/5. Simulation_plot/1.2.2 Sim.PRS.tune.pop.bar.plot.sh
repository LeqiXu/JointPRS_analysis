...
p_15K_EAS <- ggplot(long_table[which(long_table$minor_sample == "15,000" & long_table$pop == "EAS"),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
...
p_80K_EAS <- ggplot(long_table[which(long_table$minor_sample == "80,000" & long_table$pop == "EAS"),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
  scale_fill_manual(values = all_method_color, name = "All method") +
  facet_grid(p ~ pop , scales = "free_x", space = "free_x", labeller = labeller(p = p_label)) +
...
p_15K_AFR <- ggplot(long_table[which(long_table$minor_sample == "15,000" & long_table$pop == "AFR"),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
  scale_fill_manual(values = all_method_color, name = "All method") +
  facet_grid(p ~ pop , scales = "free_x", space = "free_x", labeller = labeller(p = p_label)) +
...
p_80K_AFR <- ggplot(long_table[which(long_table$minor_sample == "80,000" & long_table$pop == "AFR" ),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
  scale_fill_manual(values = all_method_color, name = "All method") +
  facet_grid(p ~ pop , scales = "free_x", space = "free_x", labeller = labeller(p = p_label)) +
...
p_15K_SAS <- ggplot(long_table[which(long_table$minor_sample == "15,000" & long_table$pop == "SAS" ),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
  scale_fill_manual(values = all_method_color, name = "All method") +
  facet_grid(p ~ pop , scales = "free_x", space = "free_x", labeller = labeller(p = p_label)) +
...
p_80K_SAS <- ggplot(long_table[which(long_table$minor_sample == "80,000" & long_table$pop == "SAS" ),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
  scale_fill_manual(values = all_method_color, name = "All method") +
  facet_grid(p ~ pop , scales = "free_x", space = "free_x", labeller = labeller(p = p_label)) +
...
p_15K_AMR <- ggplot(long_table[which(long_table$minor_sample == "15,000" & long_table$pop == "AMR" ),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
  scale_fill_manual(values = all_method_color, name = "All method") +
  facet_grid(p ~ pop , scales = "free_x", space = "free_x", labeller = labeller(p = p_label)) +
...
p_80K_AMR <- ggplot(long_table[which(long_table$minor_sample == "80,000" & long_table$pop == "AMR" ),], aes(x = minor_val_sample, y = mean_r2, group = method, fill = method)) +
  geom_bar(stat = "identity", position = "dodge", color = "black") +
  geom_text(aes(label = annotation), vjust = 0, position = position_dodge(width = 0.9), color = "red", fontface = "bold", size = 4) +  # Bold stars
  scale_fill_manual(values = all_method_color, name = "All method") +
  facet_grid(p ~ pop , scales = "free_x", space = "free_x", labeller = labeller(p = p_label)) +
...
# Render the pop plot
grid.draw(ggarrange(p_80K_EAS,p.leg, 
...
# sim_PRS_tune_bar_plot_80K_EAS.png width 1350 height 800

grid.draw(ggarrange(p_80K_AFR,p.leg, 
            ncol = 2, widths = c(0.8,0.2)))
...
# sim_PRS_tune_bar_plot_80K_AFR.png width 1350 height 800

grid.draw(ggarrange(p_80K_SAS,p.leg, 
            ncol = 2, widths = c(0.8,0.2)))
...
# sim_PRS_tune_bar_plot_80K_SAS.png width 1350 height 800

grid.draw(ggarrange(p_80K_AMR,p.leg, 
            ncol = 2, widths = c(0.8,0.2)))
...
# sim_PRS_tune_bar_plot_80K_AMR.png width 1350 height 800

# Render the pop plot
grid.draw(ggarrange(p_15K_EAS,p.leg, 
            ncol = 2, widths = c(0.8,0.2)))
...
# sim_PRS_tune_bar_plot_15K_EAS.png width 1350 height 800

grid.draw(ggarrange(p_15K_AFR,p.leg, 
            ncol = 2, widths = c(0.8,0.2)))
...
# sim_PRS_tune_bar_plot_15K_AFR.png width 1350 height 800

grid.draw(ggarrange(p_15K_SAS,p.leg, 
            ncol = 2, widths = c(0.8,0.2)))
...
# sim_PRS_tune_bar_plot_15K_SAS.png width 1350 height 800

grid.draw(ggarrange(p_15K_AMR,p.leg, 
            ncol = 2, widths = c(0.8,0.2)))
...
# sim_PRS_tune_bar_plot_15K_AMR.png width 1350 height 800